...
abstract class AppTextStyles {
  static final logoTextStyle =
      TextStyle(fontSize: 60, color: Colors.purple.shade300);
  static const homeScreenGreetingsTextStyle =
      TextStyle(fontSize: 30, color: Colors.black);
  static const dishCardNameTextStyle =
  ...
  static const nutriciousInfoCardText =
      TextStyle(fontSize: 18, color: Colors.black87);
  static const drawerItemsTextStyle =
      TextStyle(fontSize: 24, color: Colors.black87);
}
